...
# save to mazu for future use
# write_csv(habitat_marine_species_summary, here::here(fish_office_dir, "int", "habitat_marine_species_summary.csv"))
```
...
marine_live_weight_plotly <- habitat_marine_species_summary %>%
  ...
  layout(
    title = "Annual Live Weight of Marine Species Caught in Gulf of California (2006-2022)",
    xaxis = list(title = "Year"),
    yaxis = list(title = "Live Weight (kg)"),
    updatemenus = list(
      list(
...
# htmlwidgets::saveWidget(marine_live_weight_plotly, file = here::here(fish_office_dir, "int", "marine_live_weight_2006_2022_plot.html")) # for mazu
```
...
marine_revenue_plotly <- habitat_marine_species_summary %>%
  ...
  layout(
    title = "Annual Revenue from Marine Species in Gulf of California (2006-2022)",
    xaxis = list(title = "Year"),
    yaxis = list(title = "Revenue (pesos)"),
    updatemenus = list(
      list(
...
# htmlwidgets::saveWidget(marine_revenue_plotly, file = here::here(fish_office_dir, "int", "marine_revenue_2006_2022_plot.html")) # for mazu
```
