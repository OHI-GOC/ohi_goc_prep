...
goc_ggplot_map <- ggplot() +
  ...
  labs(title = "Gulf of California Protected Areas",
       fill = "Age of protected area") +
  theme(plot.title = element_text(hjust = 0.5, face = "bold"))
goc_ggplot_map

# using mapview but adding to it
# goc_mapview_fancy <- mapview(wdpa_poly_all,
#                              zcol = "iucn_cat",  # color by IUCN category
#                              layer.name = "Protected Areas",
#                              map.types = c("OpenStreetMap", "Esri.WorldImagery"),
#                              label = popupTable(wdpa_poly_all, 
#                                                 zcol = c("name", "marine", "iucn_cat")), # not working
#                              alpha.regions = 0.6)
# goc_mapview_fancy
```
