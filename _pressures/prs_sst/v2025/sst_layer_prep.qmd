...
hist_yearly_averages_trim <- terra::trim(hist_yearly_averages, value = NA)
...
current_yearly_averages_trim <- terra::trim(current_yearly_averages, value = NA)
...
terra::writeRaster(current_yearly_averages, filename = here(int_dir, paste0("current_yearly_sst_averages_goc_eq_area_2014_2023.tif")), overwrite = TRUE)

terra::writeRaster(current_yearly_averages_trim, filename = here(int_dir, paste0("trim_current_yearly_sst_averages_goc_eq_area_2014_2023.tif")), overwrite = TRUE)
```
### Visualizations
