...
```{r}
# first, we need to make a ggplot of each individual layer.  Then we can use gganimate to animate them over time.
# does not look that great...
ggplot_1980 <- ggplot() +
  geom_spatraster(data = hist_yearly_averages[[1]]) +
  scale_fill_viridis_c(option = "cividis", name = "Temperature") +
  labs(title = "Sea Surface Temperature in 1980",
